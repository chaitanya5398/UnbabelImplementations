#This model takes only Polyglot Embeddings as input, with no pos at all.
...
from data_load_no_pos import get_data_mats
...
def create_model():
    ...
    model.add(TimeDistributed(Dropout(0.5),input_shape=(None,384)))
...
if __name__=='__main__':
    ...
    #Saving predictions.
    outfile='NueralOutputsNoPos.txt'
    hteroutfile='NueralHTERsNoPos.txt'
