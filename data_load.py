#This returns an embedding of Size 684 (384 Polyglot and 150  Pos + 150 Pos)
...
def get_sentense_inputs(sent):
    ...
    for j in range(len(tr_words)):
        ...
        #The POS tags are initialised randomly.
        src_pos_embed = get_pos_embedding(j,tr_words,sc_words,align_dict)
        tar_pos_embed = src_pos_embed   #Since we dont have tagger for target languages. 
        word_embed = np.concatenate((target_embed,source_embed,src_pos_embed,tar_pos_embed),axis=0)
